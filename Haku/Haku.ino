...
void verticalProfile(dataPacket &data)
{
 int intial = seconds;
 depthCollect(data);
...
void loop() {
  // if(data.profileno > data.previousProfileno || Serial.readString() == "hi" ){
  //   reset();
  // }
  char dataSent;
  countSeconds();
